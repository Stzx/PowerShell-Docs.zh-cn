...
本主题说明如何在本地计算机上的 PowerShell 中运行后台作业。 有关在远程计算机上运行后台作业的信息，请参阅 [about_Remote_Jobs](about_Remote_Jobs.md)。 有关线程作业的详细信息，请参阅 [about_Thread_Jobs](/powershell/module/microsoft.powershell.core/about/about_Thread_Jobs)。
