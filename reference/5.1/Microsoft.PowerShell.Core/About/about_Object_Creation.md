...
- [Convertfrom-csv](xref:Microsoft.PowerShell.Utility.ConvertFrom-String)：在 [FlashExtract](https://www.microsoft.com/research/publication/flashextract-framework-data-extraction-examples)基础之上构建的，它 `ConvertFrom-String` 从结构化字符串数据创建自定义对象。
  本主题会演示和讨论所有这些方法。
