...
在默认浏览器中显示帮助文章的联机版本。 此参数仅对 cmdlet、函数、工作流和脚本帮助文章有效。 不能 **Online** `Get-Help` 在远程会话中将 Online 参数与一起使用。
...
**ShowWindow** 参数支持 (cmdlet、函数、CIM 命令、工作流、脚本) 和概念 **相关** 的命令的帮助主题。 它不支持提供程序帮助。
