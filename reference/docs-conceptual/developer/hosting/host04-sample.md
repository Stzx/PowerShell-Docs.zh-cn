...
---
# <a name="host04-sample"></a><span data-ttu-id="63201-103">Host04 示例</span><span class="sxs-lookup"><span data-stu-id="63201-103">Host04 Sample</span></span>

<span data-ttu-id="63201-104">此示例演示如何生成基于控制台的交互式主机应用程序，该应用程序可从命令行读取命令，执行命令，然后将结果显示到控制台。</span><span class="sxs-lookup"><span data-stu-id="63201-104">This sample shows how to build an interactive console-based host application that reads commands from the command line, executes the commands, and then displays the results to the console.</span></span> <span data-ttu-id="63201-105">此主机应用程序还支持显示允许用户指定多个选项的提示。</span><span class="sxs-lookup"><span data-stu-id="63201-105">This host application also supports displaying prompts that allow the user to specify multiple choices.</span></span>

## <a name="requirements"></a><span data-ttu-id="63201-106">要求</span><span class="sxs-lookup"><span data-stu-id="63201-106">Requirements</span></span>

<span data-ttu-id="63201-107">此示例需要 Windows PowerShell 2.0。</span><span class="sxs-lookup"><span data-stu-id="63201-107">This sample requires Windows PowerShell 2.0.</span></span>

## <a name="demonstrates"></a><span data-ttu-id="63201-108">演示</span><span class="sxs-lookup"><span data-stu-id="63201-108">Demonstrates</span></span>

- <span data-ttu-id="63201-109">创建一个自定义主机，其类派生自[PSHost](/dotnet/api/System.Management.Automation.Host.PSHost)类、 [PSHostUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)类和 PSHostRawUserInterface 类中的类的类和[](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)类中的类的类。</span><span class="sxs-lookup"><span data-stu-id="63201-109">Creating a custom host whose classes derive from the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class, the [System.Management.Automation.Host.PSHostUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class, and the [System.Management.Automation.Host.PSHostRawUserInterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class.</span></span>

- <span data-ttu-id="63201-110">构建一个控制台应用程序，该应用程序使用这些主机类来构建交互式 Windows PowerShell shell。</span><span class="sxs-lookup"><span data-stu-id="63201-110">Building a console application that uses these host classes to build an interactive Windows PowerShell shell.</span></span>

- <span data-ttu-id="63201-111">创建 `$profile` 变量并加载以下配置文件。</span><span class="sxs-lookup"><span data-stu-id="63201-111">Creating a `$profile` variable and loading the following profiles.</span></span>

  - <span data-ttu-id="63201-112">当前用户、当前主机</span><span class="sxs-lookup"><span data-stu-id="63201-112">current user, current host</span></span>
  - <span data-ttu-id="63201-113">当前用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="63201-113">current user, all hosts</span></span>
  - <span data-ttu-id="63201-114">所有用户，当前主机</span><span class="sxs-lookup"><span data-stu-id="63201-114">all users, current host</span></span>
  - <span data-ttu-id="63201-115">所有用户，所有主机</span><span class="sxs-lookup"><span data-stu-id="63201-115">all users, all hosts</span></span>

- <span data-ttu-id="63201-116">实现 [IHostUISupportsMultipleChoiceSelection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) 接口的接口。</span><span class="sxs-lookup"><span data-stu-id="63201-116">Implement the [System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection](/dotnet/api/System.Management.Automation.Host.IHostUISupportsMultipleChoiceSelection) interface.</span></span>

## <a name="example-1"></a><span data-ttu-id="63201-117">示例 1</span><span class="sxs-lookup"><span data-stu-id="63201-117">Example 1</span></span>

<span data-ttu-id="63201-118">此示例允许用户在命令行中输入命令，处理这些命令，然后输出结果。</span><span class="sxs-lookup"><span data-stu-id="63201-118">This example allows the user to enter commands at a command line, processes those commands, and then prints out the results.</span></span>
...
## <a name="example-2"></a><span data-ttu-id="63201-119">示例 2</span><span class="sxs-lookup"><span data-stu-id="63201-119">Example 2</span></span>

<span data-ttu-id="63201-120">下面的代码是此主机应用程序所使用的 [PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) 类的实现方式。</span><span class="sxs-lookup"><span data-stu-id="63201-120">The following code is the implementation of the [System.Management.Automation.Host.PSHost](/dotnet/api/System.Management.Automation.Host.PSHost) class that is used by this host application.</span></span> <span data-ttu-id="63201-121">未实现的那些元素会引发异常或不返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="63201-121">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="example-3"></a><span data-ttu-id="63201-122">示例 3</span><span class="sxs-lookup"><span data-stu-id="63201-122">Example 3</span></span>

<span data-ttu-id="63201-123">下面的代码是此主机应用程序所使用的 [Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) 类的实现方式。</span><span class="sxs-lookup"><span data-stu-id="63201-123">The following code is the implementation of the [System.Management.Automation.Host.Pshostuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface) class that is used by this host application.</span></span>
...
## <a name="example-4"></a><span data-ttu-id="63201-124">示例 4</span><span class="sxs-lookup"><span data-stu-id="63201-124">Example 4</span></span>

<span data-ttu-id="63201-125">下面的代码是此主机应用程序所使用的 [Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) 类的实现方式。</span><span class="sxs-lookup"><span data-stu-id="63201-125">The following code is the implementation of the [System.Management.Automation.Host.Pshostrawuserinterface](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface) class that is used by this host application.</span></span> <span data-ttu-id="63201-126">未实现的那些元素会引发异常或不返回任何内容。</span><span class="sxs-lookup"><span data-stu-id="63201-126">Those elements that are not implemented throw an exception or return nothing.</span></span>
...
## <a name="see-also"></a><span data-ttu-id="63201-127">另请参阅</span><span class="sxs-lookup"><span data-stu-id="63201-127">See Also</span></span>

 [<span data-ttu-id="63201-128">"PSHost"。</span><span class="sxs-lookup"><span data-stu-id="63201-128">System.Management.Automation.Host.PSHost</span></span>](/dotnet/api/System.Management.Automation.Host.PSHost)

 [<span data-ttu-id="63201-129">"Pshostuserinterface"。</span><span class="sxs-lookup"><span data-stu-id="63201-129">System.Management.Automation.Host.Pshostuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostUserInterface)

 [<span data-ttu-id="63201-130">"Pshostrawuserinterface"。</span><span class="sxs-lookup"><span data-stu-id="63201-130">System.Management.Automation.Host.Pshostrawuserinterface</span></span>](/dotnet/api/System.Management.Automation.Host.PSHostRawUserInterface)
