...
[Navigationcmdletprovider. Getparentpath *](/dotnet/api/System.Management.Automation.Provider.NavigationCmdletProvider.GetParentPath)方法获取指定路径处的项的父项的位置的路径。 如果指定路径中的项是数据存储区的根 (因此它没有父) ，则此方法应返回根路径。
