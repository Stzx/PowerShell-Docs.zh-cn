...
## <a name="where-can-i-install-powershell"></a><span data-ttu-id="77968-116">可将 PowerShell 安装在何处？</span><span class="sxs-lookup"><span data-stu-id="77968-116">Where can I install PowerShell?</span></span>
...
## <a name="improved-backwards-compatibility-with-windows-powershell"></a><span data-ttu-id="77968-146">改进了 Windows PowerShell 的向后兼容性</span><span class="sxs-lookup"><span data-stu-id="77968-146">Improved backwards compatibility with Windows PowerShell</span></span>
...
<span data-ttu-id="77968-157">Parallel 参数指定为每个输入日志名称并行运行的脚本块。</span><span class="sxs-lookup"><span data-stu-id="77968-157">The **Parallel** parameter specifies the script block that is run in parallel for each input log name.</span></span>
...
<span data-ttu-id="77968-172">有关[关于假设情况](/powershell/module/microsoft.powershell.core/about/about_if?view=powershell-7)的详细信息。</span><span class="sxs-lookup"><span data-stu-id="77968-172">For more information [About If](/powershell/module/microsoft.powershell.core/about/about_if?view=powershell-7).</span></span>
...
### <a name="null-conditional-assignment-operator-"></a><span data-ttu-id="77968-192">Null 条件赋值运算符 ??=</span><span class="sxs-lookup"><span data-stu-id="77968-192">Null conditional assignment operator ??=</span></span>
...
<span data-ttu-id="77968-203">在下面的示例中，将返回成员属性 Status 的值：</span><span class="sxs-lookup"><span data-stu-id="77968-203">In the following example, the value of the member property **Status** is returned:</span></span>
...
- <span data-ttu-id="77968-270">修复非 Windows 平台上的单元线程状态检查 (#11301)</span><span class="sxs-lookup"><span data-stu-id="77968-270">Fix apartment thread state check on non-Windows platforms (#11301)</span></span>
...
- <span data-ttu-id="77968-293">将 OutputType 添加到 Get-Error cmdlet 并保留原始类型名称 (#10856)</span><span class="sxs-lookup"><span data-stu-id="77968-293">Add OutputType to Get-Error cmdlet and preserve original typenames (#10856)</span></span>
...
- <span data-ttu-id="77968-314">在 Windows 上重新添加 Out-Printer 命令 (#10906)</span><span class="sxs-lookup"><span data-stu-id="77968-314">Add back Out-Printer command on Windows (#10906)</span></span>
...
- <span data-ttu-id="77968-337">修复在设置 -TotalCount 时的 Get-Content -ReadCount 0 行为 (#10749)（感谢 @eugenesmlv！）</span><span class="sxs-lookup"><span data-stu-id="77968-337">Fix Get-Content -ReadCount 0 behavior when -TotalCount is set (#10749) (Thanks @eugenesmlv!)</span></span>
...
- <span data-ttu-id="77968-358">添加 PowerShell Core 组策略定义 (#10468)</span><span class="sxs-lookup"><span data-stu-id="77968-358">Add PowerShell Core group policy definitions (#10468)</span></span>
...
### <a name="code-cleanup"></a><span data-ttu-id="77968-377">代码清理</span><span class="sxs-lookup"><span data-stu-id="77968-377">Code Cleanup</span></span>
...
- <span data-ttu-id="77968-413">使不可靠的 DSC 测试挂起 (#11131)</span><span class="sxs-lookup"><span data-stu-id="77968-413">Make unreliable DSC test pending (#11131)</span></span>
...
- <span data-ttu-id="77968-424">将测试的不明确语言从开关切换到参数以确保准确性 (#10666)（感谢 @romero126！）</span><span class="sxs-lookup"><span data-stu-id="77968-424">Replace ambiguous language for tests from switch to parameter for accuracy (#10666) (Thanks @romero126!)</span></span>
- <span data-ttu-id="77968-425">向 ForEach-Object -Parallel 测试添加实验性检查 (#10354)（感谢 @KirkMunro！）</span><span class="sxs-lookup"><span data-stu-id="77968-425">Add experimental check to ForEach-Object -Parallel tests (#10354) (Thanks @KirkMunro!)</span></span>
- <span data-ttu-id="77968-426">更新 Alpine 验证的测试 (#10428)</span><span class="sxs-lookup"><span data-stu-id="77968-426">Update tests for Alpine validation (#10428)</span></span>

### <a name="build-and-package-improvements"></a><span data-ttu-id="77968-427">生成和包改进</span><span class="sxs-lookup"><span data-stu-id="77968-427">Build and Package Improvements</span></span>

- <span data-ttu-id="77968-428">修复协调包生成的 Nuget 包签名 (#11316)</span><span class="sxs-lookup"><span data-stu-id="77968-428">Fix Nuget package signing for Coordinated Package build (#11316)</span></span>
- <span data-ttu-id="77968-429">更新 PowerShell 库和 NuGet 中的依赖项 (#11323)</span><span class="sxs-lookup"><span data-stu-id="77968-429">Update dependencies from PowerShell Gallery and NuGet (#11323)</span></span>
- <span data-ttu-id="77968-430">将 Microsoft.ApplicationInsights 从 2.11.0 升级到 2.12.0 (#11305)</span><span class="sxs-lookup"><span data-stu-id="77968-430">Bump Microsoft.ApplicationInsights from 2.11.0 to 2.12.0 (#11305)</span></span>
- <span data-ttu-id="77968-431">将 Microsoft.CodeAnalysis.CSharp 从 3.3.1 升级到 3.4.0 (#11265)</span><span class="sxs-lookup"><span data-stu-id="77968-431">Bump Microsoft.CodeAnalysis.CSharp from 3.3.1 to 3.4.0 (#11265)</span></span>
- <span data-ttu-id="77968-432">更新 Debian 10 和 11 的包 (#11236)</span><span class="sxs-lookup"><span data-stu-id="77968-432">Updates packages for Debian 10 and 11 (#11236)</span></span>
- <span data-ttu-id="77968-433">仅启用 RC 之前的实验性功能 (#11162)</span><span class="sxs-lookup"><span data-stu-id="77968-433">Only enable experimental features prior to RC (#11162)</span></span>
- <span data-ttu-id="77968-434">更新 macOS 最低版本 (#11163)</span><span class="sxs-lookup"><span data-stu-id="77968-434">Update macOS minimum version (#11163)</span></span>
- <span data-ttu-id="77968-435">将 NJsonSchema 从 10.0.27 升级到 10.0.28 (#11170)</span><span class="sxs-lookup"><span data-stu-id="77968-435">Bump NJsonSchema from 10.0.27 to 10.0.28 (#11170)</span></span>
- <span data-ttu-id="77968-436">更新 Preview.5 的 README.md 和 metadata.json 中的链接 (#10854)</span><span class="sxs-lookup"><span data-stu-id="77968-436">Updating links in README.md and metadata.json for Preview.5 (#10854)</span></span>
- <span data-ttu-id="77968-437">选择 PowerShell 拥有的符合性测试的文件 (#10837)</span><span class="sxs-lookup"><span data-stu-id="77968-437">Select the files for compliance tests which are owned by PowerShell (#10837)</span></span>
- <span data-ttu-id="77968-438">允许生成 win7x86 .msix 包。</span><span class="sxs-lookup"><span data-stu-id="77968-438">Allow win7x86 msix package to build.</span></span> <span data-ttu-id="77968-439">（内部 10515）</span><span class="sxs-lookup"><span data-stu-id="77968-439">(Internal 10515)</span></span>
- <span data-ttu-id="77968-440">允许将语义版本传递给 NormalizeVersion 函数 (#11087)</span><span class="sxs-lookup"><span data-stu-id="77968-440">Allow semantic versions to be passed to NormalizeVersion function (#11087)</span></span>
- <span data-ttu-id="77968-441">将 .NET Core 框架升级到 3.1-preview.3 (#11079)</span><span class="sxs-lookup"><span data-stu-id="77968-441">Bump .NET core framework to 3.1-preview.3 (#11079)</span></span>
- <span data-ttu-id="77968-442">在 /src/Modules 中将 PSReadLine 从 2.0.0-beta5 升级到 2.0.0-beta6 (#11078)</span><span class="sxs-lookup"><span data-stu-id="77968-442">Bump PSReadLine from 2.0.0-beta5 to 2.0.0-beta6 in /src/Modules (#11078)</span></span>
- <span data-ttu-id="77968-443">将 Newtonsoft.Json 从 12.0.2 升级到 12.0.3 (#11037) (#11038)</span><span class="sxs-lookup"><span data-stu-id="77968-443">Bump Newtonsoft.Json from 12.0.2 to 12.0.3 (#11037) (#11038)</span></span>
- <span data-ttu-id="77968-444">添加 Debian 10、11 和 CentOS 8 包 (#11028)</span><span class="sxs-lookup"><span data-stu-id="77968-444">Add Debian 10, 11 and CentOS 8 packages (#11028)</span></span>
- <span data-ttu-id="77968-445">使用 ReleaseDate 字段上传 Build-Info Json 文件 (#10986)</span><span class="sxs-lookup"><span data-stu-id="77968-445">Upload Build-Info Json file with the ReleaseDate field (#10986)</span></span>
- <span data-ttu-id="77968-446">将 .NET Core 框架升级到 3.1-preview.2 (#10993)</span><span class="sxs-lookup"><span data-stu-id="77968-446">Bump .NET core framework to 3.1-preview.2 (#10993)</span></span>
- <span data-ttu-id="77968-447">启用 x86 MSIX 包的生成 (#10934)</span><span class="sxs-lookup"><span data-stu-id="77968-447">Enable build of x86 MSIX package (#10934)</span></span>
- <span data-ttu-id="77968-448">更新 build.psm1 中的 dotnet SDK 安装脚本 URL (#10927)</span><span class="sxs-lookup"><span data-stu-id="77968-448">Update the dotnet SDK install script URL in build.psm1 (#10927)</span></span>
- <span data-ttu-id="77968-449">将 Markdig.Signed 从 0.17.1 升级到 0.18.0 (#10887)</span><span class="sxs-lookup"><span data-stu-id="77968-449">Bump Markdig.Signed from 0.17.1 to 0.18.0 (#10887)</span></span>
- <span data-ttu-id="77968-450">将 ThreadJob 从 2.0.1 升级到 2.0.2 (#10886)</span><span class="sxs-lookup"><span data-stu-id="77968-450">Bump ThreadJob from 2.0.1 to 2.0.2 (#10886)</span></span>
- <span data-ttu-id="77968-451">更新 AppX 清单和打包模块以符合 MS Store 要求 (#10878)</span><span class="sxs-lookup"><span data-stu-id="77968-451">Update AppX Manifest and Packaging module to conform to MS Store requirements (#10878)</span></span>
- <span data-ttu-id="77968-452">将 PowerShell SDK 的包引用更新为 preview.5（内部 10295）</span><span class="sxs-lookup"><span data-stu-id="77968-452">Update package reference for PowerShell SDK to preview.5 (Internal 10295)</span></span>
- <span data-ttu-id="77968-453">更新 ThirdPartyNotices.txt (#10834)</span><span class="sxs-lookup"><span data-stu-id="77968-453">Update ThirdPartyNotices.txt (#10834)</span></span>
- <span data-ttu-id="77968-454">将 Microsoft.PowerShell.Native 升级到 7.0.0-preview.3 (#10826)</span><span class="sxs-lookup"><span data-stu-id="77968-454">Bump Microsoft.PowerShell.Native to 7.0.0-preview.3 (#10826)</span></span>
- <span data-ttu-id="77968-455">将 Microsoft.ApplicationInsights 从 2.10.0 升级到 2.11.0 (#10608)</span><span class="sxs-lookup"><span data-stu-id="77968-455">Bump Microsoft.ApplicationInsights from 2.10.0 to 2.11.0 (#10608)</span></span>
- <span data-ttu-id="77968-456">将 NJsonSchema 从 10.0.24 升级到 10.0.27 (#10756)</span><span class="sxs-lookup"><span data-stu-id="77968-456">Bump NJsonSchema from 10.0.24 to 10.0.27 (#10756)</span></span>
- <span data-ttu-id="77968-457">向生成系统添加 MacPorts 支持 (#10736)（感谢 @Lucius-Q-User！）</span><span class="sxs-lookup"><span data-stu-id="77968-457">Add MacPorts support to the build system (#10736) (Thanks @Lucius-Q-User!)</span></span>
- <span data-ttu-id="77968-458">将 PackageManagement 从 1.4.4 升级到 1.4.5 (#10728)</span><span class="sxs-lookup"><span data-stu-id="77968-458">Bump PackageManagement from 1.4.4 to 1.4.5 (#10728)</span></span>
- <span data-ttu-id="77968-459">将 NJsonSchema 从 10.0.23 升级到 10.0.24 (#10635)</span><span class="sxs-lookup"><span data-stu-id="77968-459">Bump NJsonSchema from 10.0.23 to 10.0.24 (#10635)</span></span>
- <span data-ttu-id="77968-460">添加环境变量以区分 MSI 中的客户端/服务器遥测 (#10612)</span><span class="sxs-lookup"><span data-stu-id="77968-460">Add environment variable to differentiate client/server telemetry in MSI (#10612)</span></span>
- <span data-ttu-id="77968-461">将 PSDesiredStateConfiguration 从 2.0.3 升级到 2.0.4 (#10603)</span><span class="sxs-lookup"><span data-stu-id="77968-461">Bump PSDesiredStateConfiguration from 2.0.3 to 2.0.4 (#10603)</span></span>
- <span data-ttu-id="77968-462">将 Microsoft.CodeAnalysis.CSharp 从 3.2.1 升级到 3.3.1 (#10607)</span><span class="sxs-lookup"><span data-stu-id="77968-462">Bump Microsoft.CodeAnalysis.CSharp from 3.2.1 to 3.3.1 (#10607)</span></span>
- <span data-ttu-id="77968-463">更新为 Net Core 3.0 RTM (#10604)（感谢 @bergmeister！）</span><span class="sxs-lookup"><span data-stu-id="77968-463">Update to .Net Core 3.0 RTM (#10604) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="77968-464">更新 .MSIX 打包，使版本符合 Windows 应用商店要求 (#10588)</span><span class="sxs-lookup"><span data-stu-id="77968-464">Update MSIX packaging so the version to Windows Store requirements (#10588)</span></span>
- <span data-ttu-id="77968-465">将 PowerShellGet 版本从 2.2 升级到 2.2.1 (#10382)</span><span class="sxs-lookup"><span data-stu-id="77968-465">Bump PowerShellGet version from 2.2 to 2.2.1 (#10382)</span></span>
- <span data-ttu-id="77968-466">将 PackageManagement 版本从 1.4.3 升级到 1.4.4 (#10383)</span><span class="sxs-lookup"><span data-stu-id="77968-466">Bump PackageManagement version from 1.4.3 to 1.4.4 (#10383)</span></span>
- <span data-ttu-id="77968-467">更新 7.0.0-preview.4 的 README.md 和 metadata.json（内部 10011）</span><span class="sxs-lookup"><span data-stu-id="77968-467">Update README.md and metadata.json for 7.0.0-preview.4 (Internal 10011)</span></span>
- <span data-ttu-id="77968-468">将 .Net Core 3.0 版本从预览版 9 升级到 RC1 (#10552)（感谢 @bergmeister！）</span><span class="sxs-lookup"><span data-stu-id="77968-468">Upgrade .Net Core 3.0 version from Preview 9 to RC1 (#10552) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="77968-469">修复 ExperimentalFeature 列表生成（内部 9996）</span><span class="sxs-lookup"><span data-stu-id="77968-469">Fix ExperimentalFeature list generation (Internal 9996)</span></span>
- <span data-ttu-id="77968-470">将 PSReadLine 版本从 2.0.0-beta4 升级到 2.0.0-beta5 (#10536)</span><span class="sxs-lookup"><span data-stu-id="77968-470">Bump PSReadLine version from 2.0.0-beta4 to 2.0.0-beta5 (#10536)</span></span>
- <span data-ttu-id="77968-471">修复发布生成脚本以设置发布标记</span><span class="sxs-lookup"><span data-stu-id="77968-471">Fix release build script to set release tag</span></span>
- <span data-ttu-id="77968-472">将 Microsoft.PowerShell.Native 的版本更新为 7.0.0-preview.2 (#10519)</span><span class="sxs-lookup"><span data-stu-id="77968-472">Update version of Microsoft.PowerShell.Native to 7.0.0-preview.2 (#10519)</span></span>
- <span data-ttu-id="77968-473">升级到 Netcoreapp3.0 preview9 (#10484)（感谢 @bergmeister！）</span><span class="sxs-lookup"><span data-stu-id="77968-473">Upgrade to Netcoreapp3.0 preview9 (#10484) (Thanks @bergmeister!)</span></span>
- <span data-ttu-id="77968-474">确保每日协调生成，知道它是每日生成 (#10464)</span><span class="sxs-lookup"><span data-stu-id="77968-474">Make sure the daily coordinated build, knows it is a daily build (#10464)</span></span>
- <span data-ttu-id="77968-475">更新组合包生成以发布每日生成 (#10449)</span><span class="sxs-lookup"><span data-stu-id="77968-475">Update the combined package build to release the daily builds (#10449)</span></span>
- <span data-ttu-id="77968-476">删除 appveyor 引用 (#10445)（感谢 @RDIL！）</span><span class="sxs-lookup"><span data-stu-id="77968-476">Remove appveyor reference (#10445) (Thanks @RDIL!)</span></span>
- <span data-ttu-id="77968-477">将 NJsonSchema 版本从 10.0.22 升级到 10.0.23 (#10421)</span><span class="sxs-lookup"><span data-stu-id="77968-477">Bump NJsonSchema version from 10.0.22 to 10.0.23 (#10421)</span></span>
- <span data-ttu-id="77968-478">取消删除 linux-x64 生成文件夹，因为 Alpine 的某些依赖项需要它 (#10407)</span><span class="sxs-lookup"><span data-stu-id="77968-478">Remove the deletion of linux-x64 build folder because some dependencies for Alpine need it (#10407)</span></span>

### <a name="documentation-and-help-content"></a><span data-ttu-id="77968-479">文档和帮助内容</span><span class="sxs-lookup"><span data-stu-id="77968-479">Documentation and Help Content</span></span>

- <span data-ttu-id="77968-480">将更改日志重构到每个版本的一个日志中 (#11165)</span><span class="sxs-lookup"><span data-stu-id="77968-480">Refactor change logs into one log per release (#11165)</span></span>
- <span data-ttu-id="77968-481">修复 PowerShell 7 联机帮助文档的 Fwlink (#11071)</span><span class="sxs-lookup"><span data-stu-id="77968-481">Fix FWLinks for PowerShell 7 online help documents (#11071)</span></span>
- <span data-ttu-id="77968-482">更新 CONTRIBUTING.md (#11096)（感谢 @mklement0！）</span><span class="sxs-lookup"><span data-stu-id="77968-482">Update CONTRIBUTING.md (#11096) (Thanks @mklement0!)</span></span>
- <span data-ttu-id="77968-483">修复 README.md 中的安装文档链接 (#11083)</span><span class="sxs-lookup"><span data-stu-id="77968-483">Fix installation doc links in README.md (#11083)</span></span>
- <span data-ttu-id="77968-484">向 install-powershell.ps1 脚本添加示例 (#11024)（感谢 @kilasuit！）</span><span class="sxs-lookup"><span data-stu-id="77968-484">Adds examples to install-powershell.ps1 script (#11024) (Thanks @kilasuit!)</span></span>
- <span data-ttu-id="77968-485">修复 CHANGELOG.md 中的 Select-String 强调和 Import-DscResource (#10890)</span><span class="sxs-lookup"><span data-stu-id="77968-485">Fix to Select-String emphasis and Import-DscResource in CHANGELOG.md (#10890)</span></span>
- <span data-ttu-id="77968-486">从 powershell-beginners-guide.md 中删除过期链接 (#10926)</span><span class="sxs-lookup"><span data-stu-id="77968-486">Remove the stale link from powershell-beginners-guide.md (#10926)</span></span>
- <span data-ttu-id="77968-487">合并稳定且提供服务的更改日志 (#10527)</span><span class="sxs-lookup"><span data-stu-id="77968-487">Merge stable and servicing change logs (#10527)</span></span>
- <span data-ttu-id="77968-488">更新生成文档中已使用的 .NET 版本 (#10775)（感谢 @Greg-Smulko！）</span><span class="sxs-lookup"><span data-stu-id="77968-488">Update used .NET version in build docs (#10775) (Thanks @Greg-Smulko!)</span></span>
- <span data-ttu-id="77968-489">将 MSDN 中的链接替换为 powershell-beginners-guide.md 中的 docs.microsoft.com (#10778)（感谢 @iSazonov！）</span><span class="sxs-lookup"><span data-stu-id="77968-489">Replace links from MSDN to docs.microsoft.com in powershell-beginners-guide.md (#10778) (Thanks @iSazonov!)</span></span>
- <span data-ttu-id="77968-490">修复中断的 DSC 概述链接 (#10702)</span><span class="sxs-lookup"><span data-stu-id="77968-490">Fix broken DSC overview link (#10702)</span></span>
- <span data-ttu-id="77968-491">更新 Support_Question.md，以链接到作为另一个社区资源的堆栈溢出 (#10638)（感谢 @mklement0！）</span><span class="sxs-lookup"><span data-stu-id="77968-491">Update Support_Question.md to link to Stack Overflow as another community resource (#10638) (Thanks @mklement0!)</span></span>
- <span data-ttu-id="77968-492">将处理器体系结构添加到分发请求模板 (#10661)</span><span class="sxs-lookup"><span data-stu-id="77968-492">Add processor architecture to distribution request template (#10661)</span></span>
- <span data-ttu-id="77968-493">将新的 PowerShell MoL 书籍添加到学习 PowerShell Docs (#10602)</span><span class="sxs-lookup"><span data-stu-id="77968-493">Add new PowerShell MoL book to learning PowerShell docs (#10602)</span></span>
- <span data-ttu-id="77968-494">更新 v6.1.6 和 v6.2.3 版本的 README.md 和元数据 (#10523)</span><span class="sxs-lookup"><span data-stu-id="77968-494">Update README.md and metadata for v6.1.6 and v6.2.3 releases (#10523)</span></span>
- <span data-ttu-id="77968-495">修复 README.md 中的拼写错误 (#10465)（感谢 @vedhasp！）</span><span class="sxs-lookup"><span data-stu-id="77968-495">Fix a typo in README.md (#10465) (Thanks @vedhasp!)</span></span>
- <span data-ttu-id="77968-496">将对 PSKoans 模块的引用添加到学习资源文档 (#10369)（感谢 @vexx32！）</span><span class="sxs-lookup"><span data-stu-id="77968-496">Add a reference to PSKoans module to Learning Resources documentation (#10369) (Thanks @vexx32!)</span></span>
- <span data-ttu-id="77968-497">更新 7.0.0-preview.3 的 README.md 和 metadata.json（内部 #10393）</span><span class="sxs-lookup"><span data-stu-id="77968-497">Update README.md and metadata.json for 7.0.0-preview.3 (#10393)</span></span>
