...
## <a name="using-jea-with-powershell-direct"></a><span data-ttu-id="c2bb6-149">将 JEA 与 PowerShell Direct 配合使用</span><span class="sxs-lookup"><span data-stu-id="c2bb6-149">Using JEA with PowerShell Direct</span></span>
